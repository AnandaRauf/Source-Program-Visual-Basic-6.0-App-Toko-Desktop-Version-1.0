VERSION 5.00
Begin VB.Form FrmLapReturJualPeriode 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   1  'Fixed Single
   Caption         =   ".: Laporan Retur Penjualan Periode"
   ClientHeight    =   7875
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   13500
   Icon            =   "FrmLapReturJualPeriode.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7875
   ...
   End
End
Attribute VB_Name = "FrmLapReturJualPeriode"
